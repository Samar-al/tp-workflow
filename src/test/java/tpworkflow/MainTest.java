...
class MainTest {
    ...
    void testValidateCreditCardNumber_Valid() {
        ...
        final String validCardNumber = "4539 1488 0343 6467"; // Valide selon l'algorithme de Luhn
    ...
    void testValidateCreditCardNumber_Invalid() {
        ...
        final String invalidCardNumber = "1234 5678 9876 5432"; // Invalide selon l'algorithme de Luhn
    ...
    void testValidateCreditCardNumber_TooShort() {
        ...
        final String shortCardNumber = "12345"; // Trop court pour être valide
    ...
    void testValidateCreditCardNumber_TooLong() {
        ...
        final String longCardNumber = "1234 5678 9876 54321"; // Trop long pour être valide
    ...
    void testValidateCreditCardNumber_WithSpaces() {
        ...
        final String cardWithSpaces = "4539 1488 0343 6467"; // Valide avec des espaces
    ...
    void testValidateCreditCardNumber_NonNumericCharacters() {
        ...
        final String cardWithNonNumeric = "4539-1488-0343-6467"; // Valide avec des tirets
